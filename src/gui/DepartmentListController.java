...
public class DepartmentListController implements Initializable, DataChangeListener {
	...
	public void setDepartmentService(DepartmentService service) { //havia um pequeno erro nesta linha ao escrever o código, onde anteriormente, estava escrito setDepertmanet, na verdade, é setDepartment
	...
	public void updateTableView() {
		if (service == null) {
			throw new IllegalStateException("Service weas null");
		}
	...
	private void removeEntity(Department obj) {
		...
		if (result.get() == ButtonType.OK) {//get() é chamado porque o Optionn é um objeto que carrega outro objeto dentro dele, podendo ele eestar presente ou não; então, para acessar o objeto dentro do Optional, é chamado o gee()
			...
			try {
				service.remote(obj);
				updateTableView();//updateTableView chamado para, após remover os dados, forçar o usuário a atualizar os dados da tabela
			}
